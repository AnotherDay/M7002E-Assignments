...
public class GLSquareEntity extends GLEntity {
	...
	public void draw(GL2 gl, GLU glu) {
		if(edgeLength == 0) throw new IllegalArgumentException("Radius cannot be zero");
			...
			gl.glVertex3f(-edgeLength, -edgeLength, 0); //Bottom left vertex
			gl.glVertex3f(edgeLength, -edgeLength, 0); //Bottom right vertex
			gl.glVertex3f(edgeLength, edgeLength, 0); //Top right vertex
			gl.glVertex3f(-edgeLength, edgeLength, 0); //Top left vertex
			gl.glEnd();
			gl.glPopAttrib();
			gl.glPopMatrix();
		}
